...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 01, 2025 at 09:06 PM
...
CREATE TABLE `games` (
  ...
  `plataforma` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
(1, 'Bomberman', 'Bomberman é uma série de jogos de estratégia desenvolvida pela Hudson Soft, lançada pela primeira vez em 1983. O objetivo principal do jogo é plantar bombas estratégicamente para destruir obstáculos e inimigos em um labirinto labiríntico.', 300.00, 'Nintendo', 'Arcade', 98, '2025-11-17 21:34:00', '2025-12-01 20:18:45', 'https://i.pinimg.com/1200x/cb/02/52/cb0252075d75bb701a088c20560fa67d.jpg'),
(2, 'Earthworm', NULL, 449.99, 'nintendo', 'aventura', 98, '2025-11-20 21:10:08', '2025-12-01 20:12:50', 'https://i.pinimg.com/736x/c2/84/11/c28411baeaecceee52a63693f07f8830.jpg'),
...
(4, 'The Legend of Zelda', NULL, 299.99, 'nintendo', 'aventura', 98, '2025-11-20 21:34:09', '2025-12-01 20:12:50', 'https://i.pinimg.com/736x/15/3f/06/153f0641d82636ae6ff1f0cdbe08f293.jpg'),
...
(23, 'God of War Ragnarok', NULL, 99.99, 'playstation', 'aventura', 99, '2025-11-20 22:15:54', '2025-12-01 20:22:04', 'https://i.pinimg.com/736x/c7/53/e1/c753e123b7151a399e8245673ac707a4.jpg'),
...
(25, 'Wild Arms', NULL, 99.99, 'playstation', 'aventura', 99, '2025-11-20 22:15:54', '2025-12-01 20:22:04', 'https://i.pinimg.com/736x/67/d4/4e/67d44e6d7004da0965ad370ef7fc1778.jpg'),
...
(28, 'Fallout', NULL, 99.99, 'playstation', 'aventura', 99, '2025-11-20 22:15:54', '2025-12-01 20:29:27', 'https://i.pinimg.com/736x/6a/6a/7f/6a6a7fdbd30e42b85e1760651c6b353c.jpg'),
...
(31, 'Pokémon Stadium', 'Um jogo eletrônico do gênero batalha e estratégia', 150.00, 'Nintendo', 'Estratégia', 10, '2025-12-01 21:04:58', '2025-12-01 21:04:58', 'https://i.pinimg.com/1200x/00/fe/d4/00fed40463877b3f1ca1679f85e4fb1b.jpg');
...
CREATE TABLE `orders` (
  ...
  `status` enum('Pendente','Processando','Enviado','Entregue','Cancelado') COLLATE utf8mb4_general_ci NOT NULL,
...
(2, 27, '2025-12-01', 'Pendente', 749.98, '2025-12-01 20:12:50', '2025-12-01 20:12:50'),
(3, 27, '2025-12-01', 'Pendente', 749.98, '2025-12-01 20:12:50', '2025-12-01 20:12:50'),
(4, 27, '2025-12-01', 'Pendente', 300.00, '2025-12-01 20:18:45', '2025-12-01 20:18:45'),
(5, 27, '2025-12-01', 'Pendente', 300.00, '2025-12-01 20:18:45', '2025-12-01 20:18:45'),
(6, 23, '2025-12-01', 'Pendente', 199.98, '2025-12-01 20:22:04', '2025-12-01 20:22:04'),
(7, 23, '2025-12-01', 'Pendente', 99.99, '2025-12-01 20:29:27', '2025-12-01 20:29:27');
...
(2, 2, 2, 1, 449.99, '2025-12-01 20:12:50', '2025-12-01 20:12:50'),
(3, 2, 4, 1, 299.99, '2025-12-01 20:12:50', '2025-12-01 20:12:50'),
(4, 3, 2, 1, 449.99, '2025-12-01 20:12:50', '2025-12-01 20:12:50'),
(5, 3, 4, 1, 299.99, '2025-12-01 20:12:50', '2025-12-01 20:12:50'),
(6, 4, 1, 1, 300.00, '2025-12-01 20:18:45', '2025-12-01 20:18:45'),
(7, 5, 1, 1, 300.00, '2025-12-01 20:18:45', '2025-12-01 20:18:45'),
(8, 6, 23, 1, 99.99, '2025-12-01 20:22:04', '2025-12-01 20:22:04'),
(9, 6, 25, 1, 99.99, '2025-12-01 20:22:04', '2025-12-01 20:22:04'),
(10, 7, 28, 1, 99.99, '2025-12-01 20:29:27', '2025-12-01 20:29:27');
...
(3, 23, '2025-12-01 17:28:46', '2025-12-01 17:29:34'),
(4, 28, '2025-12-01 17:29:51', '2025-12-01 18:06:03');
...
CREATE TABLE `users` (
  ...
  `genero` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mae` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `cpf` varchar(14) COLLATE utf8mb4_general_ci NOT NULL,
  `email` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `celular` varchar(16) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fixo` varchar(16) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `rua` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `numero` varchar(5) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `complemento` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `user_type` enum('A','C') COLLATE utf8mb4_general_ci NOT NULL COMMENT 'A=Administrador, C=Cliente',
  `criado` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `atualizado` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(27, 'Senhora', '1987-10-10', 'F', 'Senhora', '12345678911', 'senhora@email.com', '2199999991', '2132518798', 'Rua do Rio', '13', 'praça 15', '23036-156', 'Campo Grande', 'Rio de Janeiro', 'RJ', 'Senhora', '$2y$10$MvlgPCLkIv6FbOGoWZZ31uHHDhSaj3YlY9UmRcxOh3B6MmI/ZlK3K', 'C', '2025-11-20 20:43:01', '2025-12-01 19:57:54'),
(28, 'Administrador', '2025-11-25', 'M', 'Mãe', '00000000000', 'admin@email.com', '21995748605', '', 'Rua Canadá Oeste', '63', '', '23810-060', 'Jardim América', 'Itaguaí', 'RJ', 'Admin', '$2y$10$I6eQNJgexSax7xURgcSqeu69DBZELL7q9e/12sHBmnTNJdm5.ddCC', 'A', '2025-11-25 23:04:08', '2025-11-25 23:04:41');
