...
<body>
  ...
  <div id="floating-menu" class="floating-menu">
    <ul>
      ...
      <li class="link2">
        <a href="../HomePage/Nintendo.html"><img
            src="../utils/img/LogoNintendo.png"
            alt="Nintendo"
            width="20" />
          Nintendo</a>
  ...
  <section class="hero slider">
    <div class="slide-track">
      <div class="slide">
        <img
          class="img"
          src="../utils/img_Banner/Banner-Nintendo-Studios.jpg"
          alt="Banner Nintendo Studios" />
      </div>
      <div class="slide">
        <img
          class="img"
          src="../utils/img_Banner/Banner-PS-Studios.jpg"
          alt="Banner PS Studios" />
      </div>
      <div class="slide">
        <img
          class="img"
          src="../utils/img_Banner/Banner-xbox-Studios.jpg"
          alt="Banner Xbox Studios" />
      </div>
      <div class="slide">
        <img
          class="img"
  ...
  <section class="jogos" id="playstation">
    ...
    <a href="Playstation.php" target="_blank">
      <div class="grid">
        <div class="jogo">
          <img
            src="../utils/img/ghost-of-yotei-game-3840x2160-19048.jpg"
            alt="Ghost Of Yotei" />
        ...
        <div class="jogo">
          <img
            src="../utils/img_games_playstation/the-alters.jpg"
            alt="The Alters" />
          <h3>The Alters</h3>
          <p>R$ 249,90</p>
        </div>
  ...
  <section class="jogos" id="xbox">
    ...
    <a href="Xbox.php" target="_blank">
      <div class="grid">
        <div class="jogo">
          <img
            src="../utils/img_games_x-box/senuasSacrifice.jpg"
        ...
        <div class="jogo">
          <img
            src="../utils/img_games_x-box/senuasSaga.jpg"
