  ...
  <main class="main-content container">
    <div class="product-grid" id="product-grid">
      <div class="product-card">
        <img
          id="imagem"
          src="../utils/games_nintendo/bomberman-generation-17334.jpg"
          alt="Bomberman" />
      ...
      <div class="product-card">
        <img
          id="imagem"
          src="../utils/games_nintendo/Earthworm_Jim_Super.jpg"
          alt="Earthworm" />
        <div class="product-info">
      ...
      <div class="product-card">
        <img
          id="imagem"
          src="../utils/games_nintendo/castlevania_dracula_x.jpg"
      ...
      <div class="product-card">
        <img
          id="imagem"
          src="../utils/games_nintendo/Final_Fight.jpg"
          alt="Final Fight" />
        <div class="product-info">
      ...
      <div class="product-card">
        <img
          id="imagem"
          src="../utils/games_nintendo/Legend_of_Zelda_Breath_of_the_Wild_capa.png"
          alt="Legend of Zelda" />
        <div class="product-info">
      ...
      <div class="product-card">
        <img
          id="imagem"
          src="../utils/games_nintendo/Super_Mario_64.jpg"
          alt="Super Mario 64" />
        <div class="product-info">
      ...
      <div class="product-card">
        <img
          id="imagem"
          src="../utils/games_nintendo/Super_Mario_Allstar.jpg"
          alt="Super Mario allstar" />
        <div class="product-info">
      ...
      <div class="product-card">
        <img
          id="imagem"
          src="../utils/games_nintendo/Super_Mario_Party.png"
          alt="Mario Party" />
        <div class="product-info">
      ...
      <div class="product-card">
        <img
          id="imagem"
          src="../utils/games_nintendo/Mario Kart 8 S pass.jpg"
          alt="Mario Kart" />
        <div class="product-info">
      ...
      <div class="product-card">
        <img
          id="imagem"
          src="../utils/games_nintendo/the-legend-of-zelda-tears-of-the-kingdom_cover.jpg"
